function [Data, Data_alt, W, W_alt, Model, Model_alt] = read_in_and_organize_moments(simMoms)
[Data, Data_alt, W, W_alt] = target_stats();
    ...
    spbSIM               = simMoms.model_shareD; % fraction of firms with 1 buyer, 2 buyers, etc.

% using degree distribution regression coefficients as targets    
...
% drop degree distribution regression coefficients, add spbSIM

 Model_alt = cat(1,match_death_coefsSIM,match_ar1_coefsSIM,...
    mavshipSIM,exp_dom_coefsSIM,dom_ar1_coefsSIM,ln_haz_coefsSIM,...   
    succ_rate_coefsSIM,sr_var_coefsSIM,for_sales_shrSIM,...    
    exp_fracSIM,spbSIM);
end