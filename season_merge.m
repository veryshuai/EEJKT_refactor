function [mat_yr_sales,firm_yr_sales,flip_firm] = season_merge(iterX_in,mm)
...
[mat_yr_sales, firm_yr_sales, flip_firm] = season_mergeAnnualizeDat(all_seas, som_seas, mm, mat_cols,iterX_in);
