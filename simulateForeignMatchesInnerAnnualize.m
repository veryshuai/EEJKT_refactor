...
iter_out = simulateForeignMatchesInnerAnnualizeDuds(iter_in, mm, iter_out); % # unsuccessful meetings (duds) over previous year, by firm (needed for degree distribution later)
