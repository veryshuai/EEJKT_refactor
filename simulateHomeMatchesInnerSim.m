...
%  mat_tran = iterH_in.mat_tran;
 iterH_in.N_match = iterH_in.N_match + size(iterH_in.mat_tran,1);
    ...
    if iterH_in.season == mm.pd_per_yr
        ...
        ttt = ones(size(iterH_in.firm_yr_sales,1),1).*[t,iterH_in.ptm_type];
        ...
        if iterH_in.year > mm.burn  % cosntruct moments for firm domestic sales regressions
            ...
            [x,y,fmoms_xx,fmoms_xy,fysum,fn_obs] =...
                firm_reg_h_moms(iterH_in.firm_yr_sales, iterH_in.firm_yr_sales_lag,...
