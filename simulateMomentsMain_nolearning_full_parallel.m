function simMoms = simulateMomentsMain_nolearning_full_parallel(policy_cell,mm)
...
parfor pt_ndx = 1:mm.N_pt
    ...
    %choose relevant policy structure for theta type
    theta_ind_ndx = mm.pt_type(pt_ndx,2);
    policy = policy_cell{theta_ind_ndx};
