...
% returns the data statistics used in the loss function
    ...
    % ln_haz_coefs      from RDC disclosure 11-09-23 
...
%   exp_dom_coefsDAT     = [12.03057,0.3439815,2.477^2]; % Marcela's updated figures 9/15/23  
%   moments 18-20    
...
%   moment 27
    for_sales_shrDAT     =  0.1616; % mean share of exports to U.S. in total sales (Marcela revised stat 7-8-23)
%   moment 28    
    exp_fracDAT          =  0.0954; % fraction of firms that export to U.S.
