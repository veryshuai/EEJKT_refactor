        ...
        for trial_ind = 2:mm.n_size + 1
            for succ_ind = 1:trial_ind
                ...
                if succ_ind > 1 && mm.gam >= 0
                    pol_diff = lambda_f(succ_ind,trial_ind,1,succ_ind,prod_ind,mac_shk_ind)...
                        - lambda_f(succ_ind-1,trial_ind,1,succ_ind,prod_ind,mac_shk_ind);
                    if pol_diff < 0
                ...
                if mac_shk_ind > 1
                    pol_diff = lambda_f(succ_ind,trial_ind,1,succ_ind,prod_ind,mac_shk_ind)...
                        - lambda_f(succ_ind,trial_ind,1,succ_ind,prod_ind,mac_shk_ind-1);
                    if pol_diff < 0
                ...
                if prod_ind > 1
                    pol_diff = lambda_f(succ_ind,trial_ind,1,succ_ind,prod_ind,mac_shk_ind)...
                        - lambda_f(succ_ind,trial_ind,1,succ_ind,prod_ind-1,mac_shk_ind);
                    if pol_diff < 0
                ...
                if trial_ind > 1 && succ_ind < trial_ind
                    pol_diff = lambda_f(succ_ind,trial_ind,1,succ_ind,prod_ind,mac_shk_ind)...
                        - lambda_f(succ_ind,trial_ind-1,1,succ_ind,prod_ind,mac_shk_ind);
                    if pol_diff > 0
    ...
    for mac_shk_ind = 1:2*mm.x_size + 1
        for succ_rt_ind = 1:mm.dim1
            for succ_ind = 1:succ_rt_ind
                ...
                if succ_ind > 1 && mm.gam >=0
                    pol_diff = lambda_h(1,succ_rt_ind,succ_ind,prod_ind,mac_shk_ind)...
                        - lambda_h(1,succ_rt_ind,succ_ind-1,prod_ind,mac_shk_ind);
                    if pol_diff < 0
                ...
                if prod_ind > 1
                    pol_diff = lambda_h(1,succ_rt_ind,succ_ind,prod_ind,mac_shk_ind)...
                        - lambda_h(1,succ_rt_ind,succ_ind,prod_ind-1,mac_shk_ind);
                    if pol_diff < 0
                ...
                if mac_shk_ind > 1
                    pol_diff = lambda_h(1,succ_rt_ind,succ_ind,prod_ind,mac_shk_ind)...
                        - lambda_h(1,succ_rt_ind,succ_ind,prod_ind,mac_shk_ind-1);
                    if pol_diff < 0
                ...
                if succ_rt_ind > 1
                    pol_diff = lambda_h(1,succ_rt_ind,succ_ind,prod_ind,mac_shk_ind)...
                        - lambda_h(1,succ_rt_ind-1,succ_ind,prod_ind,mac_shk_ind);
                    if pol_diff < 0
